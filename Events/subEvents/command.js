...
module.exports.run = async(bot, message, prefix) => {
    ...
    else if(['credits', 'credit', 'madeby', 'owner', 'vanity', 'vanitybot'].includes(commandName)) return message.reply(bot.embed('This bot was made by **Kye#8411**\nIf you need help feel free to join my discord, https://discord.gg/kye\n\nTo use vanity make sure the bots role is above the assigned role and the bot\nhas permission to type in assigned channel'))
    else return;
